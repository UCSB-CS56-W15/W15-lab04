package edu.ucsb.cs56.w15.drawings.eshong.simple;
...
/**
   ...
   @author Elliott S Hong (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Elliott S Hong", 20,40);
    }
