...
/**
   A vector drawing of a disarmed clock that implements
...
*/
public class DisarmedClock extends GeneralPathWrapper implements Shape {
    /**
     ...
     */
    public DisarmedClock(double x, double y, double radius)
    {
