package edu.ucsb.cs56.w15.drawings.nikolas_chaconas.simple;
import java.awt.Graphics;
import java.awt.Graphics2D;
import javax.swing.JPanel;
import javax.swing.JComponent;

import edu.ucsb.cs56.w15.drawings.pconrad.simple.Circle;
...
/**
   ...
   @author Nikolas Chaconas (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
        	new Circle
        	(
        		snowManCenterBottomX, snowManCenterBottomY - bottomRadius*2 - middleRadius*2- topRadius, topRadius
        	);
       ...
       g2.drawString("Top of snowman added by Nikolas Chaconas", 20,40);
    }
