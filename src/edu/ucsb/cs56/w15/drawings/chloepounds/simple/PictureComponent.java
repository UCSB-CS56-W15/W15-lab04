package edu.ucsb.cs56.w15.drawings.chloepounds.simple;
...
/**
   ...
   @author Chloe Pounds (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Chloe Pounds", 20,40);
    }
