package edu.ucsb.cs56.w15.drawings.jingzhou.simple;
...
public class PictureViewer
{
   public static void main(String[] args)
   {
      ...
      frame.setSize(888,666); // @@@ MODIFY THIS LINE IF YOU LIKE
      
      // Set your own title
      frame.setTitle("Jingzhou's Drawing"); // @@@ MODIFY THIS LINE
