...
public class AllMyDrawings
{
	...
	BasketballCourt h1 = new BasketballCourt(100,100,100);
	...
	ThreePointCourt hw1 = new ThreePointCourt(50,250,200);
	ThreePointCourt hw2 = new ThreePointCourt(300,450,500);
