package edu.ucsb.cs56.w15.drawings.npoon.simple;
...
/**
   ...
   @author Nicholas Poon (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Nicholas Poon", 20,40);
    }
