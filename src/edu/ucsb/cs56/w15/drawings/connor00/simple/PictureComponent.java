package edu.ucsb.cs56.w15.drawings.connor00.simple;
...
/**
   ...
   @author Connor Armbrust Mulcahey (fixed the snowmans's head)
...
{  
   ...
   {  
	  ...
	  (
       ...
       g2.drawString("Top of snowman added by Connor Armbrust Mulcahey", 20,40);
    }
