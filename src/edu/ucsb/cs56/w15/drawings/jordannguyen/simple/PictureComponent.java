package edu.ucsb.cs56.w15.drawings.jordannguyen.simple;
...
/**
   ...
   @author Jordan Nguyen (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
	   ...
	   new Circle
	   (
	    snowManCenterBottomX, snowManCenterBottomY - bottomRadius * 2 - middleRadius * 2 
	    - topRadius,
	    topRadius
	   );
       ...
       g2.drawString("Top of snowman added by Jordan Nguyen", 20,40);
    }
