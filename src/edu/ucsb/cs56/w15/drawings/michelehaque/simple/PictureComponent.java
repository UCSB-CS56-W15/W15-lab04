package edu.ucsb.cs56.w15.drawings.michelehaque.simple;
...
/**
   ...
   @author Michele Haque (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Michele Haque", 20,40);
    }
